...
format:
  html: 
    ...
    theme:
     light: litera
     dark: cyborg
bibliography: cite/packages.bib
nocite: |
  @R-tidyverse
  @R-arrow
  @R-gt
...
@fig-vis-example shows the output of the visualising function for one chemical (Sertraline Hydrochloride, BNF code `r {SERTRALINE_HCL}`).
