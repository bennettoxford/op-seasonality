...
3. Norethisterone (0604012P0)
4. Antipsychotic depot injections (040202******)
...
2. Monthly items per working days (This is to eliminate potentially spurious time series signals due to significant difference in number of working days among months in the data).
...
1. Examining the robustness of the pipeline to disruptive events such as the COVID-19 pandemic.
